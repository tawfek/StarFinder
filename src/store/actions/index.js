import {SET_IS_PERSON_DATA_LOADING,SET_PERSON_FULL_INFORMATION,SHOW_PERSON_DRAWER,SET_PERSON,ADD_CELEBRITIES,SET_SHOW_DRAWER,UPDATE_IS_LOADING,SET_IMAGE_URL, SET_LOADING_PROGRESS} from '../constants/action-types'
