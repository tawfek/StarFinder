      ...
      <div>
        <div>
          <Row className="white">
            <Col
              span={18}
              style={{ padding: "10px", marginTop: "3vh" }}
              push={5}
            ></Col>
            <Col span={5} pull={18} style={{ padding: "20px" }}>
              <Link to="/home">
                ...
                <Icon
                  ...
                  type="star"
                />{" "}
                <span className="logo-text-sm">Star Finder</span>{" "}
              </Link>
              <br />
            </Col>
            <Col
              span={1}
              style={{ marginTop: "3vh", position: "relative", right: "3vh" }}
            >
              <Button
                className="red"
      ...
      <Router>
        ...
        <nav className="menuBar">
          <div className="logo white">
            <Link className="white" to="/home">
              ...
              <Icon
                ...
                type="star"
              />{" "}
              <span className="logo-text white">Star Finder</span>{" "}
            </Link>
          </div>
          <div className="menuCon white">
            ...
            <div className="rightMenu white"></div>
