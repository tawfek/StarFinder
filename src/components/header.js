...
<div className="card-define white biglogo" style={{width:"100%"}}  >
<span style={{fontSize:"4vh",position:"relative"}}><Icon theme="filled" type="star" style={{color:"yellow"}} /> Star Finder </span>
<br/>
<div className="swch" style={{textAlign:"center"}}>
    <Switch style={{textAlign:"center"}}
     ...
     defaultChecked={(cookies.get('theme')===undefined)?false:(cookies.get('theme')==='dark')?true:false}
