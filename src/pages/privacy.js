      ...
      <Fragment>
        ...
        <Row type="flex" justify="center">
          ...
          >
            <Row>
              <Col
                style={{ height: "100%", padding: 20, marginBottom: "15vh" }}
                sm={24}
              >
                <h1 className="pfont">
                  <Icon type="profile" /> Privacy Policy{" "}
                  <small style={{ fontSize: 13, color: "lightgrey" }}>
                    (Last update in 2019/07/15)
                  </small>
                </h1>{" "}
                <p>
                  Tawfek mohammed built the Star finder app as a Free app. This
                  SERVICE is provided by Tawfek mohammed at no cost and is
                ...
                <p>
                  ...
                  as in our Terms and Conditions, which is accessible at Star
                  finder unless otherwise defined in this Privacy Policy.
                </p>{" "}
                <p>
                ...
                <p>
                  ...
                  information, including but not limited to Ip , useragent. The
                ...
                <p>
                  ...
                  <a href="/contact" className="customa">
                    {" "}
                    contact me
                  </a>
                </p>
